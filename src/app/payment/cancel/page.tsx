    ...
    <div className="min-h-screen bg-background px-4 py-16 text-foreground">
      <div className="mx-auto max-w-xl rounded-xl border border-border bg-card p-8 text-center shadow-sm">
        ...
        <div className="mt-6 flex justify-center gap-3">
          <Link href="/tenantdashboard/payments" className="rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground">
            Try Again
          </Link>
          <Link href="/tenantdashboard" className="rounded-lg border border-border px-4 py-2 text-sm font-medium">
            Dashboard
          </Link>
        </div>
      </div>
